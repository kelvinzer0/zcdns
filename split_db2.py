...
with open("backend/db/db.go", "r") as f:
    content = f.read()
...
with open("backend/db/models.go", "w") as f:
    f.write(models)
...
with open("backend/db/db.go", "w") as f:
    f.write(db_go)

with open("backend/db/db_users.go", "w") as f:
    f.write("""package db
...
with open("backend/db/db_records.go", "w") as f:
    f.write("""package db
...
with open("backend/db/db_logs.go", "w") as f:
    f.write("""package db
...
with open("backend/db/db_parental.go", "w") as f:
    f.write("""package db
...
with open("backend/db/db_abuse.go", "w") as f:
    f.write("""package db
